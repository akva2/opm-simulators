...
EclMixingRateControls<FluidSystem>::
...
{
    EclMixingRateControls<FluidSystem> result(schedule);
    result.lastRv_ = {21.0};
...
template<class FluidSystem>
bool EclMixingRateControls<FluidSystem>::
...
template<class FluidSystem>
void EclMixingRateControls<FluidSystem>::
...
template<class FluidSystem>
typename EclMixingRateControls<FluidSystem>::Scalar
EclMixingRateControls<FluidSystem>::
...
template class EclMixingRateControls<BlackOilFluidSystem<double,BlackOilDefaultIndexTraits>>;
