...
template<class Scalar>
struct ToleranceMb { static constexpr Scalar value = 1e-6; };
...
struct MinStrictCnvIter { static constexpr int value = 0; };
...
struct LocalWellSolveControlSwitching { static constexpr bool value = false; };
struct UseImplicitIpr { static constexpr bool value = false; };
