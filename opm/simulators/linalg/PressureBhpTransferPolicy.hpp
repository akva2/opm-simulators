...
namespace Opm
{
    ...
    namespace Details
    {
        template<class Scalar> using PressureMatrixType = Dune::BCRSMatrix<Opm::MatrixBlock<Scalar, 1, 1>>;
        ...
        using ParCoarseOperatorType
            = Dune::OverlappingSchwarzOperator<PressureMatrixType<Scalar>,
                                               PressureVectorType<Scalar>,
                                               PressureVectorType<Scalar>, Comm>;
        template <class Scalar, class Comm>
    ...
    class PressureBhpTransferPolicy : public Dune::Amg::LevelTransferPolicyCpr<FineOperator,
                                                                               Details::CoarseOperatorType<Scalar,Communication>>
    {
    public:
    ...
    public:
        ...
        void createCoarseLevelSystem(const FineOperator& fineOperator) override
        {
            ...
            if (prm_.get<bool>("add_wells")) {
                ...
                const Scalar overflow_fraction = 1.2;
