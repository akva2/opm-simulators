...
template<class T> using FluidSys = BlackOilFluidSystem<T, BlackOilDefaultIndexTraits>;

#define INSTANCE_TYPE(T)                                         \
    template class WellAssemble<FluidSys<T>>;                    \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,3,0u>)   \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,4,0u>)   \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,5,0u>)   \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,6,0u>)   \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,7,0u>)   \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,8,0u>)   \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,9,0u>)   \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,4u>)  \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,5u>)  \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,6u>)  \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,7u>)  \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,8u>)  \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,9u>)  \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,10u>) \
    INSTANCE_METHODS(FluidSys<T>, DenseAd::Evaluation<T,-1,11u>)
