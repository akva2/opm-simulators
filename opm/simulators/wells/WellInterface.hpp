...
protected:
    ...
    std::vector<double> initialWellRateFractions(const Simulator& ebosSimulator,
    ...
    virtual void checkOperabilityUnderTHPLimit(const Simulator& ebos_simulator,
                                               const WellState<Scalar>& well_state,
                                               DeferredLogger& deferred_logger) = 0;

    virtual void updateIPR(const Simulator& ebos_simulator,
                           DeferredLogger& deferred_logger) const = 0;
