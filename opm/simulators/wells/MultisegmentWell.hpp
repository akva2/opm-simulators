...
namespace Opm
{
    ...
    public:
        ...
        void updateIPRImplicit(const Simulator& model_simulator,
                               WellState& well_state,
                               DeferredLogger& deferred_logger) override;
        ...
        std::vector<double> computeCurrentWellRates(const Simulator& modelSimulator,
                                                    DeferredLogger& deferred_logger) const override;
    ...
    protected:
        ...
        void computeInitialSegmentFluids(const Simulator& model_simulator);

        // compute the pressure difference between the perforation and cell center
        void computePerfCellPressDiffs(const Simulator& modelSimulator);
        ...
        void computeSegmentFluidProperties(const Simulator& modelSimulator,
                                           DeferredLogger& deferred_logger);
        ...
        void computeWellRatesAtBhpLimit(const Simulator& modelSimulator,
                                        std::vector<double>& well_flux,
                                        DeferredLogger& deferred_logger) const;

        void computeWellRatesWithBhp(const Simulator& modelSimulator,
                                     const double& bhp,
                                     std::vector<double>& well_flux,
                                     DeferredLogger& deferred_logger) const override;
        ...
        EvalWell getSegmentSurfaceVolume(const Simulator& model_simulator, const int seg_idx) const;
        ...
        double maxPerfPress(const Simulator& model_simulator) const;
