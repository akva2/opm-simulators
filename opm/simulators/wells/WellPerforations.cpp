...
gasOilRate(std::vector<Value>& cq_s,
...
template<class FluidSystem, class Indices, class Scalar, class Value>
void WellPerforations<FluidSystem,Indices,Scalar,Value>::
gasOilRateCrossflow(const std::vector<Value>& cq_s,
                    PerforationRates& perf_rates,
                    const Value& rv,
                    const Value& rs,
                    const Value& pressure,
...
template<class FluidSystem, class Indices, class Scalar, class Value>
void WellPerforations<FluidSystem,Indices,Scalar,Value>::
gasWaterRate(std::vector<Value>& cq_s,
             PerforationRates& perf_rates,
             const Value& rvw,
...
template<class FluidSystem, class Indices, class Scalar, class Value>
void WellPerforations<FluidSystem,Indices,Scalar,Value>::
gasWaterRateCrossflow(const std::vector<Value>& cq_s,
                      PerforationRates& perf_rates,
                      const Value& rvw,
                      const Value& rsw) const
{
...
volumeRatioDisOilVapWat(const Value& rvw,
                        const Value& rsw,
                        const Value& pressure,
