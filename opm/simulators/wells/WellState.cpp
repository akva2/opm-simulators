...
void WellState<Scalar>::gatherVectorsOnRoot(const std::vector<data::Connection>& from_connections,
...
template<class Scalar>
template<class Comm>
void WellState<Scalar>::communicateGroupRates(const Comm& comm)
{
...
template<class Scalar>
template<class Comm>
void WellState<Scalar>::updateGlobalIsGrup(const Comm& comm)
{
...
#define INSTANCE_TYPE(T)                            \
    ...
    template void WellState<T>::                    \
        updateGlobalIsGrup<Comm>(const Comm& comm); \
    template void                                   \
        WellState<T>::communicateGroupRates<Comm>(const Comm& comm);
