...
namespace Opm {
    ...
    public:
        ...
        */
        ...
        static AdaptiveTimeSteppingEbos<TypeTag> serializationTestObject()
        {
            AdaptiveTimeSteppingEbos<TypeTag> result;

            result.timeStepControlType_ = TimeStepControlType::PID;
            result.timeStepControl_ = std::make_unique<PIDTimeStepControl>();
