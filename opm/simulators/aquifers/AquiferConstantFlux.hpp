...
public:
    ...
    static AquiferConstantFlux serializationTestObject(const Simulator& model_simulator)
    {
        AquiferConstantFlux<TypeTag> result({}, model_simulator, {});
    ...
    void endTimeStep() override
    {
        ...
        this->cumulative_flux_ +=
            this->flux_rate_ * this->model_simulator_.timeStepSize();
    }
...
private:
    ...
    double initializeConnections()
    {
        ...
        this->cellToConnectionIdx_
            .resize(this->model_simulator_.gridView().size(/*codim=*/0), -1);
    ...
    {
        const auto tot_face_area = this->model_simulator_.vanguard()
