...
public:
    ...
    AquiferFetkovich(const std::vector<Aquancon::AquancCell>& connections,
        ...
        : Base(aqufetp_data.aquiferID, connections, modelSimulator)
        , aqufetp_data_(aqufetp_data)
    {
    }

    static AquiferFetkovich serializationTestObject(const Simulator& modelSimulator)
    {
        AquiferFetkovich result({}, modelSimulator, {});
